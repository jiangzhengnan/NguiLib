 ...
 * @date 2020/6/23
 */
public class TestSvView extends View {
    ...
    public TestSvView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public TestSvView(Context context, AttributeSet attrs, int defStyleAttr) {
