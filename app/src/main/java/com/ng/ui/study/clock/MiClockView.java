...
/**
 * https://blog.csdn.net/qq_31715429/article/details/54668668
 * 仿小米时钟
 */
public class MiClockView extends View {
    ...
    public MiClockView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextSize = ta.getDimension(R.styleable.MiClockView_textSize, DensityUtil.INSTANCE.spTopx(context, 14));
        ta.recycle();
